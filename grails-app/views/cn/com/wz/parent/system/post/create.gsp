...
<html>
	...
	<body>
		...
		<div id="create-post" class="content scaffold-create" role="main">
			...
			<g:form action="save" >
			<input type="hidden" id="organ1" name='organ1' value="${organ }">
				<fieldset class="form">
					<g:render template="/cn/com/wz/parent/system/post/form"/>
				</fieldset>
			...
			$('.cancel').attr('href','javascript:void(0);');
			 $.omMessageBox.confirm({
	                ...
	                onClose:function(value){
		                if(value){
		                	window.location.href="${createLink(controller:'post',action:'index')}";
			              }
	                }
	            });
		});
