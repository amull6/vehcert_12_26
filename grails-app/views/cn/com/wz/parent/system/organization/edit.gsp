		...
		<div id="edit-organization" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<fieldset class="buttons" style="margin:20px 8px 0px 4px;padding-left:280px;">
					...
					<g:link controller="organization" class="cancel" params="[currentCategoryId:organizationInstance?.id]">${message(code: 'default.button.cancel.label', default: 'Cancel')}</g:link>
				</fieldset>
			</g:form>
		</div>
