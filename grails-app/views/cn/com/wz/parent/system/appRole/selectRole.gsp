		...
		<div id="page" style="width:100%;background-color:white;">
					...
					<table style="width:100%;border:0px;">
					  <tr>
					    ...
					    <td align="center" valign="middle">
					    	<input type="hidden" id="appId" name="appId" value="${params.appId }"/>
	 	...
	 	<script>
			...
			function confirmForSelect () {
    			...
    			//保存数据
    			var url= "${createLink(controller:'appManage',action:'save')}"+"?roleIds="+roleIds+"&appId="+appId;
			...
			function buildRightGrid(opFlag){
				var url='';
				var roleId=$('#appId').val();
			    url='${createLink(controller:'appManage',action:'selectRolesByApp')}?opFlag='+opFlag+'&'+$('#form_query').serialize();
                $('#content').omGrid({
                    dataSource:url,
