...
<form id="page" style="margin:8px;">
    <div id="center-panel" style="margin-left:4px;border:1px;">
        ...
        <fieldset class="buttons" style="margin:0px 8px 8px 4px;">
            ...
            <export:formats formats="['excel']"    style="border:0px;margin-top:-23px;margin-left:123px;"/>
        </fieldset>
...
<script>
    ...
    $(function() {
        ...
        $('#btn_deleteSearch').click(function(){
            //这里利用Ajax删除数据
            var veh_Clxh= $("#clmc").val();
            var veh_Clmc=$("#clxh").val();
            ...
            $.omMessageBox.confirm({
                ...
                onClose:function(value){
                    if(value){
                        var deleteUrl = '${createLink(controller:'preCarStorage',action:'jsonDeleteSearch')}';
