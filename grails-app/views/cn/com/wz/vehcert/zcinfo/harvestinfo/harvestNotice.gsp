        ...
        <form id="form_query" style="margin:8px;height:80px;">
            <table style="width:100%;border:0px;">
                ...
                <td width="60px" align="left"><span><g:textField id="veh_Fdjxh" name="veh_Fdjxh" style="width:120px;"  value=""/></span></td>
                    ...
                    <td width="100" align="right"><span><g:message code="nzcarstorage.veh_Zycs.label" default="机械产品的主要参数" />:</span></td>
...
<script>
    $(function() {
        ...
        $('#btn_query').omButton({
            width:80,
            onClick:function(){
                var url = "${createLink(controller:'harvestInfo',action:'jsonNotice')}";
        ...
        $("#veh_Clxh").change( function() {
            ...
            if(veh_Clxh!='') {
                $('#veh_Fdjxh').omCombo('setData',"${createLink(controller:'harvestInfo',action:'jsonInfoSuggestion')}?field=veh_Fdjxh&veh_Clxh="+veh_Clxh+"&random="+Math.random());
                $('#veh_Jxdl').omCombo('setData',"${createLink(controller:'harvestInfo',action:'jsonInfoSuggestion')}?field=veh_Jxdl&veh_Clxh="+veh_Clxh+"&random="+Math.random());
                $('#veh_Rllx').omCombo('setData',"${createLink(controller:'harvestInfo',action:'jsonInfoSuggestion')}?field=veh_Rllx&veh_Clxh="+veh_Clxh+"&random="+Math.random());
                $('#veh_Jxxlb').omCombo('setData',"${createLink(controller:'harvestInfo',action:'jsonInfoSuggestion')}?field=veh_Jxxlb&veh_Clxh="+veh_Clxh+"&random="+Math.random());
                $('#veh_Zycs').omCombo('setData',"${createLink(controller:'harvestInfo',action:'jsonInfoSuggestion')}?field=veh_Zycs&veh_Clxh="+veh_Clxh+"&random="+Math.random());
                $('#veh_Pfjd').omCombo('setData',"${createLink(controller:'harvestInfo',action:'jsonInfoSuggestion')}?field=veh_Pfjd&veh_Clxh="+veh_Clxh+"&random="+Math.random());
            }
        });
        $('#btn_clear').omButton({
            width:80,
...
//                    alert("offsettop="+this.offsetTop);
            ...
            colModel:[
                ...
                {header : "车辆类型", width : 100, align : 'center',name : 'car_storage_type'},
