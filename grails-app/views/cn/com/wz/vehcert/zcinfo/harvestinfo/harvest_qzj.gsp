                                    ...
                                    <div align="left" class="innerCol ">
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <g:select style="width:143px;" name="car_storage_type" from="${['3':'青贮机']}"  value="${HarvestInfoInstance?.car_storage_type}" optionKey="key" optionValue="value"></g:select>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
