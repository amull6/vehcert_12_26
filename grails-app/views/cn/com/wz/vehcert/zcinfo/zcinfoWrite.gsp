                ...
                <div align="left" class="innerCol " style="text-align: center;">
                    ...
                    <a id="submit"  class="btn_basic blue_black" style="width:80px;font-size: 14px;" >确定</a>
                     <g:if test="${replaceType}">
                        ...
                        %{--正常更换的手动填写--}%
                        <a id="cancel"  class="btn_basic blue_black" style="width:80px;font-size: 14px;" href="${createLink(controller:'ZCInfo',action:'zcinfoRound')}?turnOff=${turnOff}" >返回</a>
                    </g:else>
...
<script>
    $(function() {
        ...
        $('#submit').click(function(){
              ...
              var url="${createLink(controller:'ZCInfo',action:'saveWrite')}?veh_Zchgzbh="+veh_Zchgzbh+"&veh_Fzrq="+veh_Fzrq+"&veh_Clsbdh="+veh_Clsbdh+"&veh_Csys="+veh_Csys+"&veh_Fdjxh="+veh_Fdjxh+"&veh_Fdjh="+veh_Fdjh+"&veh_Clzzrq="+veh_Clzzrq+"&carstorageId="+carstorageId+"&veh_Zzbh="+veh_Zzbh+'&replaceType='+replaceType+'&turnOff='+turnOff;
