        ...
        <form id="form_query" style="margin:8px;">
            <table style="width:100%;border:0px;">
                <tr>
                    ...
                    <td width='10'></td>
                    <td width="80" align="right"><span>操作类型：</span></td>
                    <td>
...
<script>
    ...
    $(function() {
        ...
        $('#btn_query').omButton({
            width:80,
            onClick:function(){
                var url = "${createLink(controller:'ZCInfoTemp',action:'jsonList')}";
        ...
        $(".excel").click(function(){
            ...
            var url="${createLink(controller:'ZCInfoTemp',action:'export_search_is')}?format=excel&extension=xlsx&firstTime="+firstTime+"&secondTime="+secondTime;
    ...
    function buildRightGrid(){
        $('#zcinfo_grid').omGrid({
            dataSource:"${createLink(controller:'ZCInfoTemp',action:'jsonList')}",
            title:"<g:message code="default.list.label" args="[entityName]"/>",
            singleSelect:false,
            ...
            height :440,
            colModel:[
                {header : "操作类型", width : 50, align : 'center',name : 'type',
                    renderer:function(value,rowData,rowIndex){
                        if(value==1){
                            return '<span style="color: green">下载</span>';
                        }else if(value==0){
                            return '<span style="color: red">打印</span>';
                        }
                    }},
