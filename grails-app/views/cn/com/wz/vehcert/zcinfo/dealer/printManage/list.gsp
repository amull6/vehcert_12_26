    ...
    function buildRightGrid(){
        $('#printCount_grid').omGrid({
            ...
            colModel:[
                ...
                {header : "${message(code: 'zcinfo.printCount.label', default: '经销商打印次数')}", name : 'printCount', width : 100, align : 'center'},
                {header : "${message(code: 'zcinfo.limitPrintCount.label', default: '限制打印次数')}", name : 'limitPrintCount', width : 100, align : 'center'},
