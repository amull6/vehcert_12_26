...
<div id="edit-user" class="content scaffold-edit" role="main">
    ...
    <g:hasErrors bean="${distributorPrintCount}">
        <ul class="errors" role="alert">
                <g:eachError bean="${distributorPrintCount}" var="error">
    ...
    <g:form method="post" >
        ...
        <g:hiddenField name="version" value="${distributorPrintCount?.version}" />
    ...
    $(".cancel").click(function(){
        ...
        $.omMessageBox.confirm({
            ...
            onClose:function(value){
                if(value){
                    window.location.href="${createLink(controller:'printCount',action:'index')}";
                }
            }
        });
    });
