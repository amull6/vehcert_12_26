    ...
    $(function() {
        $('#relate').omButton({
            ...
            onClick:function(){
                ...
                if(veh_Clsbdh!=''){
                    var url = "${createLink(controller:'ZCInfo',action:'zcinfoRondByDp')}?veh_Clsbdh="+veh_Clsbdh+'&replaceType='+replaceType+'&turnOff='+turnOff;
        ...
        $('#newOld').click(function (){
                ...
                url=encodeURI(url);
                $.post(url,{newId:newId,veh_Clsbdh:veh_Clsbdh,veh_Zzbh:veh_Zzbh,zid:zid,veh_Need_Cer:veh_Need_Cer,statusWrite:statusWrite,replaceType:replaceType,veh_Clsbdh_Dp:veh_Clsbdh_Dp,newDpId:newDpId},function(data,textStatus){
                    if(textStatus){
                        $.omMessageBox.alert({
                            type:'success',
                            title:'提示',
                            ...
                            onClose:function(value){
                                var url = '${createLink(controller:'ZCInfo',action:'replaceTwoTime')}?replaceType='+replaceType+'&turnOff='+turnOff;
                                window.location.href=url;
                            }
                        });
                    }
        ...
        $('#write').omButton({
            ...
            onClick:function(){
                var replaceType=$('#replaceType').val();
                var turnOff=$('#turnOff').val();
                var url = '${createLink(controller:'ZCInfo',action:'zcinfoRondWrite')}'+'?replaceType='+replaceType+'&turnOff='+turnOff;
                window.location.href=url;
            }
        });
