...
<html>
    ...
    <div style="margin-top:0px;margin-left: 5px;display: none" class="print" id='print'>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <table id="customers">
        <tr>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px" >1．合格证编号</td>
            <td colspan="3"style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px"align="center" >${NZInfoInstance?.veh_Hgzbh}</td>
        </tr>
        <tr>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px" >2．发证日期</td>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px"align="center"> ${NZInfoInstance?.veh_Fzrq}</td>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px" >3．生产企业名称</td>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px"align="center" >${NZInfoInstance?.veh_Scqymc}</td>
        </tr>
        <tr>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px" >4．品牌</td>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px"align="center" >${NZInfoInstance?.veh_Pp}</td>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px" >5．类型</td>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px"align="center" >${NZInfoInstance?.veh_Lx}</td>
        </tr>
        <tr>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px" >6．型号名称</td>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px"align="center" >${NZInfoInstance?.veh_Cx}</td>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px" >7．发动机型号</td>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px"align="center" >${NZInfoInstance?.veh_Fdjxh}</td>
        </tr>
        <tr>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px" >8．发动机号码</td>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px"align="center" >${NZInfoInstance?.veh_Fdjh}</td>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px" >9．功率/kW</td>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px"align="center" >${NZInfoInstance?.veh_Gl}</td>
        </tr>
        <tr>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px" >10．排放标准号及排放阶段</td>
            <td colspan="3"style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px"align="center" >${NZInfoInstance?.veh_Pfbz}</td>
        </tr>
        <tr>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px" >11．出厂编号</td>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px"align="center" >${NZInfoInstance?.veh_new_clbh}</td>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px" >
            ...
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px"align="center" >${NZInfoInstance?.veh_Dph}</td>
        </tr>
        <tr>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px" >13．机身颜色</td>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px"align="center" >${NZInfoInstance?.veh_Jsys}</td>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px" >14．转向操纵方式</td>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px"align="center" >${NZInfoInstance?.veh_Zxczxs}</td>
        </tr>
        <tr>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px" >15．准乘人数</td>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px"align="center" >${NZInfoInstance?.veh_Zcrs}</td>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px" >16．轮轴数</td>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px"align="center" >
        ...
        <tr>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px" >17．轴距/mm</td>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px"align="center" >
            ...
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px" >18．轮胎数</td>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px"align="center" >
        ...
        <tr>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px" >19．轮胎规格</td>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px"align="center" >
            ...
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px" >20．轮距（前/后）/mm</td>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px"align="center" >
        ...
        <tr>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px" >21．履带数</td>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px"align="center" >
            ...
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px" >22．履带规格</td>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px"align="center">
        ...
        <tr>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px" >23．轨距/mm</td>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px"align="center" >
            ...
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px" >24．外廓尺寸/mm</td>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px"align="center" >${NZInfoInstance?.veh_Wkc}*${NZInfoInstance?.veh_Wkk}*${NZInfoInstance?.veh_Wkg}</td>
        </tr>
        <tr>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px" >
            ...
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px"align="center" >${NZInfoInstance?.veh_Bdqyl}</td>
            <td rowspan="4" style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px" >29．二维码/条码</td>
            <td rowspan="4" style="font-size:1em;border:1px solid black" align="center">
                <g:if test="${NZInfoInstance?.qr_name}">
                <img id="pic_fp_photo" src="${request.contextPath}/attachment/getImg?QRpiUrl=${NZInfoInstance?.qr_name}" width="90%" height="90%"/>
                %{--<img id="pic_fp_photo" src="http://qr.liantu.com/api.php?text=合格证编号:${NZInfoInstance?.veh_Hgzbh}；%0A发证日期:${NZInfoInstance?.veh_Fzrq}；%0A生产企业名称:${NZInfoInstance?.veh_Scqymc}；%0A品牌:${NZInfoInstance?.veh_Pp}；%0A类型:${NZInfoInstance?.veh_Lx}；%0A型号名称:${NZInfoInstance?.veh_Cx}；%0A发动机型号:${NZInfoInstance?.veh_Fdjxh}；%0A发动机号码:${NZInfoInstance?.veh_Fdjh}；%0A功率/kW:${NZInfoInstance?.veh_Gl}；%0A排放标准号及排放阶段:${NZInfoInstance?.veh_Pfbz}；%0A出厂编号:${NZInfoInstance?.veh_new_clbh}；%0A底盘号:${NZInfoInstance?.veh_Dph}" width="90%" height="50%"/>--}%
                </g:if>
            </td>
        </tr>
        <tr>
            ...
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px"align="center" >${NZInfoInstance?.veh_Zxsyzl}</td>
        </tr>
        <tr>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px" >
                <g:if test="${type=='tractor_A'||type=='tractor_B'||type=='tractor_C'||type=='tractor_J'}">
        ...
        <tr>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px" >28．生产日期</td>
            <td style="font-size:1em; border:1px solid black;padding:3px 7px 2px 7px;width:145px;height:30px"align="center" >${NZInfoInstance?.veh_Ccrq}</td>
        </tr>
        <tr>
