...
<tr class="om-grid-row oddRow">
    ...
    <td align="left" abbr="id" class="col0" colspan="4"><div align="left" class="innerCol" id='veh_Clbh_R' >${NZzcinfModel?.veh_Clbh}</div></td>
</tr>
...
<tr class="om-grid-row evenRow">
    ...
    <td align="left" class="indexCol" colspan="4"><div align="left" class="innerCol " >2.底盘号</div></td>
    <td align="left" abbr="id" class="col0" colspan="4"><div align="left" class="innerCol " id="veh_Dph_R">${NZzcinfModel?.veh_Dph}</div></td>
</tr>
<tr class="om-grid-row oddRow">
    ...
    <td align="left" class="indexCol" colspan="4"><div align="left" class="innerCol " style="color: red">3.车型</div></td>
    <td align="left" abbr="id" class="col0" colspan="4"><div align="left" class="innerCol " ><input type="text" name='veh_Cx_R' id="veh_Cx_R" value=""></div></td>
...
<tr class="om-grid-row evenRow">
    ...
    <td align="left" class="indexCol" colspan="4"><div align="left" class="innerCol " style="color: red">4.出厂日期</div></td>
    <td align="left" abbr="id" class="col0" colspan="4">
        <div align="left" class="innerCol " >
            <c:dataPicker name="veh_Ccrq" id="veh_Ccrq_R" style="width: 120px" editable="false"  dateFormat="yy年mm月dd日"  value=""></c:dataPicker>
             %{--<input type="text"  name='veh_Ccrq_R' id="veh_Ccrq_R" value="">--}%
        </div>
    </td>
...
<tr class="om-grid-row oddRow">
    ...
    <td align="left" class="indexCol" colspan="4"><div align="left" class="innerCol " style="color: red" >5.发动机号</div></td>
    <td align="left" abbr="city" class="col1" colspan="4"><div align="left" class="innerCol " ><input type="text" id="veh_Fdjh_R" name='veh_Fdjh_R' value=""></div></td>
</tr>
<tr class="om-grid-row evenRow">
...
<tr class="om-grid-row evenRow">
    <td align="center" abbr="id" class="col0" colspan="17"><div align="center" class="innerCol ">
        <form id="form" method="post">
            ...
            <input type="hidden" value="${opFlag}"name='opFlag' id="opFlag">
...
<script>
    $(function() {
        ...
        $('#newOld').click(function (){
                ...
                var veh_Cx_R=$('#veh_Cx_R').val();

                var veh_Ccrq=$('#veh_Ccrq').html();
                var veh_Ccrq_R=$('#veh_Ccrq_R').val();

                var veh_Fdjh=$('#veh_Fdjh').html();
                var veh_Fdjh_R=$('#veh_Fdjh_R').val();
                ...
                var opFlag=$('#opFlag').val();
                if(veh_Cx_R==''||veh_Cx_R==null){
                    alert('请填写更换后车型');
                    return
                }
                if(veh_Ccrq_R==''||veh_Ccrq_R==null){
                        alert('请填写更换后出厂日期');
                    return
                }
                if(veh_Fdjh_R==''||veh_Fdjh_R==null){
                    alert('请填写更换后发动机型号');
                    return
                }
            ...
            if(salesManPhone==''||salesManPhone==null){
                alert('请填写业务员联系电话');
                return
            }
              if(remark==''||remark==null){
                ...
                var url= '${createLink(controller:'NZzcinfoReplaceAuth',action:'nzZcinfoReplaceSave')}?veh_Clbh='+veh_Clbh+'&salesManName='+salesManName+'&salesManPhone='+salesManPhone+'&remark='+remark;
                url=encodeURI(url);
                        ...
                        if(textStatus){
                            $.omMessageBox.alert({
                                ...
                                onClose:function(value){
                                    var url = '${createLink(controller:'NZInfo',action:'nzInfoFormalChange')}?opFlag='+opFlag;
                                    window.location.href=url;
                                }
                            });
                        }
