...
<g:hiddenField name="kind" value="1"/>
...
//                }
        ...
        $('#btn_query').click(function(){
            ...
            var  veh_Zchgzbh=$('#veh_Zchgzbh').val();
            if(veh_Zchgzbh.length==14){
                window.location.href = url+'?processType=0&kind=1&veh_Zchgzbh='+veh_Zchgzbh;
            }
        });
        ...
        $('#btn_nextview').click(function(){
            ...
            var  veh_Zchgzbh=$('#veh_Zchgzbh').val();
            if(veh_Zchgzbh.length==14){
                window.location.href = url+'?processType=0&kind=1&direction=1&veh_Zchgzbh='+veh_Zchgzbh;
            }
        });
        ...
        $('#recover').click(function(){
            ...
            var  veh_Zchgzbh=$('#veh_Zchgzbh').val();
            if(veh_Zchgzbh.length==14){
                window.location.href = url+'?processType=0&kind=1&recover=0&veh_Zchgzbh='+veh_Zchgzbh;
            }
        });
            ...
            if(d.flag=='successed'){
                ...
                $.omMessageBox.alert({
                    ...
                    onClose:function(v){
                        ...
                        var  veh_Zchgzbh=$('#veh_Zchgzbh').val();
                        if(veh_Zchgzbh.length==14){
                            window.location.href = url+'?processType=0&kind=1&veh_Zchgzbh='+veh_Zchgzbh+'&intI=1';
                        }
                    }
                });
            }else{
