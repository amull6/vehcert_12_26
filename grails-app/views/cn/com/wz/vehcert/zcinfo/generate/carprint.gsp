...
<html>
	<head>
		...
		<g:set var="entityName" value="汽车合格证打印" />
                        ...
                        <table id="grid" style="width: 80%" cellpadding="0" cellspacing="0" border="0">
                            ...
                            <tr class="om-grid-row oddRow">
                                <td align="left" class="indexCol"><div align="left" class="innerCol " style="width:200px">选择车辆状态信息：
                                    <p>
                                        <g:if test="${zcinfoInstance?.veh_Clztxx=='QX'}">
                                            <label>
                                                    <input type="radio" name="type" value="QX" <g:if test="${zcinfoInstance?.veh_Clztxx == 'QX'}"> checked="checked"</g:if><g:else >style="display: none;"</g:else>/>
                                                    全项（QX）
                                            </label>

                                            %{--<label>--}%
                                                    %{--<input type="radio" name="type" value="DP" <g:if test="${zcinfoInstance?.veh_Clztxx == 'DP'}"> checked="checked"</g:if><g:else >style="display: none;"</g:else> />--}%
                                                    %{--底盘（DP）--}%
                                            %{--</label>--}%
                                        </g:if>
                                        <g:elseif test="${zcinfoInstance?.veh_Clztxx=='DP'}">
                                    ...
                                    <div align="left" class="innerCol ">
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <g:textField readonly="true" name="veh_Dphgzbh" id="veh_Dphgzbh" maxlength="50"  value="${zcinfoInstance?.veh_Dphgzbh}"/>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                                ...
                                <td align="left" abbr=""colspan="4">
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>准牵引总质量</td><td> <g:textField readonly="true" name="veh_Zqyzzl" id="veh_Zqyzzl" maxlength="50"  value="${zcinfoInstance?.veh_Zqyzzl}"/></td>
                                        </tr>
                                        <tr>
                                            <td>额定载客</td><td><g:textField readonly="true" name="veh_Edzk" id="veh_Edzk" maxlength="50"  value="${zcinfoInstance?.veh_Edzk}"/></td>
                                            <td>载质量利用系数</td><td><g:textField readonly="true" name="veh_Zzllyxs" id="veh_Zzllyxs" maxlength="50"  value="${zcinfoInstance?.veh_Zzllyxs}"/></td>
                                            ...
                                            <td>底盘ID</td><td><g:textField readonly="true" name="veh_Dpid" id="veh_Dpid" maxlength="50"  value="${zcinfoInstance?.veh_Dpid}"/></td>
                                        </tr>
                                        <tr>
                                            <td>底盘型号 </td><td><g:textField readonly="true"  name="veh_Dpxh" id="veh_Dpxh" maxlength="50"  value="${zcinfoInstance?.veh_Dpxh}"/></td>
                                            <td>驾驶室类型</td><td><g:textField readonly="true"  name="veh_Jsslx" id="veh_Jsslx" maxlength="50"  value="${zcinfoInstance?.veh_Jsslx}"/></td>
                                            <td>半挂车鞍座最大允许总质量</td><td><g:textField readonly="true" name="veh_Bgcazzdyxzzl" id="veh_Bgcazzdyxzzl" maxlength="50"  value="${zcinfoInstance?.veh_Bgcazzdyxzzl}"/></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>轴数</td><td><g:textField readonly="true" name="veh_Zs" id="veh_Zs" maxlength="50"  value="${zcinfoInstance?.veh_Zs}"/></td>
...
//            })
            ...
            %{--$('#btn_select').click(function(){--}%
                ...
                %{--var url = '${createLink(controller:'ZCInfo',action:'toNotice')}?veh_Need_Cer='+veh_Need_Cer;--}%
                %{--create(url,'公告信息',800,600);--}%
            %{--});--}%
            ...
            $('#btn_query').click(function(){
                ...
                if(veh_Zchgzbh_Re.length==0){
                    ...
                    window.location.href = url+'?kind=2&vehZchgzbhRe='+veh_Zchgzbh_Re;
                }
            });
            $('#scan').click(function(){
