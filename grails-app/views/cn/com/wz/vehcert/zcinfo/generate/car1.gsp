...
<head>
    ...
    <g:set var="entityName" value="非常规汽车合格证生成" />
...
<input type="hidden" name="veh_other" value=""/>
...
//                    }
        ...
        $('#btn_query').click(function(){
            ...
            var  veh_Zchgzbh=$('#veh_Zchgzbh').val();
            if(veh_Zchgzbh.length==14){
                window.location.href = url+'?processType=1&kind=0&veh_Zchgzbh='+veh_Zchgzbh;
            }
        });
        ...
        $('#btn_nextview').click(function(){
            ...
            var  veh_Zchgzbh=$('#veh_Zchgzbh').val();
            if(veh_Zchgzbh.length==14){
                window.location.href = url+'?processType=1&kind=0&direction=1&veh_Zchgzbh='+veh_Zchgzbh;
            }
        });
