...
<html>
	<head>
		...
		<g:set var="entityName" value="汽车合格证生成" />
    ...
    <div id="page" style="width:100%;background-color:white;margin:0px 0px">
        <div id="center-panel" style="margin-left:4px;border:1px;">
            ...
            <form id="form" action="${createLink(controller: 'ZCInfo',action:'managesave')}" method="post">
                ...
                <input type="hidden" name="turnOff" id="turnOff" value="${turnOff}"/>

                <g:hiddenField name="infoid" value="${zcinfoInstance.id }"/>
                <g:hiddenField name="kind" value="0"/>
                <g:hiddenField name="veh_Type" value="0"/>
                        ...
                        <table id="grid" style="width: 80%" cellpadding="0" cellspacing="0" border="0">
                            ...
                            <tr class="om-grid-row oddRow">
                                ...
                                <td align="left" abbr="address" class="col2">
                                    SAP序列号：
                                    <g:if test="${zcinfoInstance?.SAP_No==null}">
                                        <g:textField name="SAP_No"  backgroundColor= 'green' id="SAP_No"  maxlength="50"  value="${zcinfoInstance?.SAP_No}"/>
                                    </g:if>
                                    <g:else>
                                        <g:textField name="SAP_No" readonly="readonly" id="SAP_No"  maxlength="50"  value="${zcinfoInstance?.SAP_No}"/>
                                    </g:else>
                                </td>
                            </tr>
                            <tr class="om-grid-row evenRow">
    ...
    <script>
        $(function() {
            ...
            $('#btn_query').click(function(){
                ...
                if(veh_Zchgzbh_Re.length==0){
                    ...
                    window.location.href = url+'?kind=0&vehZchgzbhRe='+veh_Zchgzbh_Re;
                }
            });
        ...
        function saveAndPrint(printType){
            ...
            if(veh_Zchgzbh.length==14){
                ...
                //验证合格证的公告信息是否符合条件
                $.post("${createLink(controller: 'ZCInfo',action:'check')}",params,function(dd,textStatus){
                    ...
                    if(d1.flag=='failed'){
                       ...
                       alert(d1.msg);
                        ...
                        var updateUrl="${createLink(controller: 'ZCInfo',action:'managesave')}?printType="+printType ;
