...
<g:hiddenField name="processType" value="0"/>
<g:hiddenField name="infoid" value="${zcinfoInstance.id}"/>
<g:hiddenField name="kind" value="0"/>
...
<g:hiddenField name="isupload" value="${zcinfoInstance.web_status }"/>
<g:hiddenField name="veh_other" value=""/>
...
<tr class="om-grid-row oddRow">
    <td align="left" class="indexCol"><div align="left" class="innerCol " style="width:200px">选择车辆状态信息：
        <p>
        <label>
            <g:if test="${symboMap.containsKey('carload')}">
                <input type="radio" name="type" attr='QX'  value="${symboMap.get('carload')}"
                    <g:if test="${symboMap.containsKey('check_carload')}">
                        checked="checked"
                    </g:if>
                />
                全项（QX）</label>
        ...
        <label>
            <g:if test="${symboMap.containsKey('chassis')}">
                <input type="radio" name="type" attr='DP' value="${symboMap.get('chassis')}"
                    <g:if test="${symboMap.containsKey('check_chassis')}">
                        checked="checked"
                    </g:if>
                />
                底盘（DP）</label>
    ...
    <td align="left" abbr="address" class="col2"><div align="left" class="innerCol " style="width:200px">
        <input id="recover" type="button"  class="edit" style="width:100px; height: 30px;" value="恢复合格证编号"/></div>
    </td>
</tr>
        ...
        <div align="left" class="innerCol ">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <g:textField name="veh_Dphgzbh" id="veh_Dphgzbh" maxlength="50"  value="${zcinfoInstance?.veh_Dphgzbh}"/>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <td align="left" abbr=""colspan="4">
        <table>
            ...
            <tr>
                ...
                <td>准牵引总质量</td><td> <g:textField name="veh_Zqyzzl" id="veh_Zqyzzl" maxlength="50"  value="${zcinfoInstance?.veh_Zqyzzl}"/></td>
            </tr>
            <tr>
                <td>额定载客</td><td><g:textField name="veh_Edzk" id="veh_Edzk" maxlength="50"  value="${zcinfoInstance?.veh_Edzk}"/></td>
                <td>载质量利用系数</td><td><g:textField name="veh_Zzllyxs" id="veh_Zzllyxs" maxlength="50"  value="${zcinfoInstance?.veh_Zzllyxs}"/></td>
                <td>车辆制造企业其他信息</td><td><g:textField name="veh_Qyqtxx" id="veh_Qyqtxx" maxlength="50"  value="${zcinfoInstance?.veh_Qyqtxx}"/></td>
                <td>底盘ID</td><td><g:textField name="veh_Dpid" id="veh_Dpid" maxlength="50"  value="${zcinfoInstance?.veh_Dpid}"/></td>
            </tr>
            <tr>
                <td>底盘型号 </td><td><g:textField name="veh_Dpxh" id="veh_Dpxh" maxlength="50"  value="${zcinfoInstance?.veh_Dpxh}"/></td>
                <td>驾驶室类型</td><td><g:textField name="veh_Jsslx" id="veh_Jsslx" maxlength="50"  value="${zcinfoInstance?.veh_Jsslx}"/></td>
                <td>半挂车鞍座最大允许总质量</td><td><g:textField name="veh_Bgcazzdyxzzl" id="veh_Bgcazzdyxzzl" maxlength="50"  value="${zcinfoInstance?.veh_Bgcazzdyxzzl}"/></td>
            ...
            <tr>
                ...
                <td>轴数</td><td><g:textField name="veh_Zs" id="veh_Zs" maxlength="50"  value="${zcinfoInstance?.veh_Zs}"/></td>
...
//                    }
        ...
        $('#btn_query').click(function(){
            ...
            var  veh_Zchgzbh=$('#veh_Zchgzbh').val();
            if(veh_Zchgzbh.length==14){
                window.location.href = url+'?processType=0&kind=0&veh_Zchgzbh='+veh_Zchgzbh;
            }
        });
        $('#recover').click(function(){
            ...
            var  veh_Zchgzbh=$('#veh_Zchgzbh').val();
            if(veh_Zchgzbh.length==14){
                window.location.href = url+'?processType=0&kind=0&recover=0&veh_Zchgzbh='+veh_Zchgzbh;
            }
        });
        ...
        $('#btn_nextview').click(function(){
            ...
            var  veh_Zchgzbh=$('#veh_Zchgzbh').val();
            if(veh_Zchgzbh.length==14){
                window.location.href = url+'?processType=0&kind=0&direction=1&veh_Zchgzbh='+veh_Zchgzbh;
            }
        });
            ...
            if(d.flag=='successed'){
                ...
                $.omMessageBox.alert({
                    ...
                    onClose:function(v){
                        ...
                        var  veh_Zchgzbh=$('#veh_Zchgzbh').val();
                        if(veh_Zchgzbh.length==14){
                            window.location.href = url+'?processType=0&kind=0&veh_Zchgzbh='+veh_Zchgzbh+'&intI=1';
                        }
                    }
                });
            }else{
    ...
    function changeData(data){
        ...
        $('#veh_other').val(data.veh_other)      //其它
    }
    ...
    function calculateVin(){
        ...
        var veh_zdjgl=$('#veh_zdjgl').val();
        var veh_other=$('#veh_other').val();
        $.post(url,{"veh_zdjgl":veh_zdjgl,"veh_other":veh_other,"kind":kind,'veh_VinFourBit':veh_VinFourBit,'veh_Zzl':veh_Zzl,'veh_Jsslx':veh_Jsslx,'veh_Rlzl':veh_Rlzl,'veh_Pl':veh_Pl,'veh_Zs':veh_Zs,'veh_Zj':veh_Zj,'veh_Zchgzbh':veh_Zchgzbh,'veh_Cpscdz':veh_Cpscdz},function(data){
            if(data.flag=='0'){
                alert(data.msg);
            }else if(data.flag=='1'){
    ...
    function print(){
        ...
        <g:if test="${printSet?.printerName}">
        VehCert2.Veh_PrinterName ='${printSet?.printerName}';   //目标打印机 虚拟打印机
        </g:if>
