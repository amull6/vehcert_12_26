...
<form id="form" action="${createLink(controller: 'ZCInfo',action:'managesave')}" method="post">
    ...
    <g:hiddenField name="infoid" id="infoid" value="${zcinfoInstance.id }"/>
    <g:hiddenField name="kind" id="kind" value="1"/>
    <g:hiddenField name="veh_Type" id="veh_Type" value="1"/>
    ...
    <g:hiddenField name="veh_Clztxx" id="veh_Clztxx" value="${zcinfoInstance.veh_Clztxx }"/>
    ...
    $(function() {
        ...
        $('#btn_query').click(function(){
            ...
            if(veh_Zchgzbh_Re.length==0){
                ...
                window.location.href = url+'?kind=1&vehZchgzbhRe='+veh_Zchgzbh_Re;
            }
        });
