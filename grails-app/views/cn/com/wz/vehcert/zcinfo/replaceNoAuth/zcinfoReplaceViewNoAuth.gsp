...
<tr class="om-grid-row evenRow">
    <td align="center" abbr="id" class="col0" colspan="17"><div align="center" class="innerCol ">
        ...
        %{--</g:if>--}%
        <a id="btn_back" class="btn_basic blue_black" href="javascript:void(0)" onclick="javascript:window.location.href='${createLink(controller:'ZCInfoNoAuth',action:'salesListNoAuth')}?searchType=${searchType}&username=${username}'">返回</a>
    </div></td>
</tr>
</tbody>
</table>
