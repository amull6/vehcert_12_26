...
<script>
    ...
    function noticeSelect(rowIndex){
        ...
        if(supplement=="0"){
            ...
            parent.$('#veh_Fdjxh').html(data.veh_Fdjxh);//發動機型號
            ...
            parent.$('#veh_Cpscdz').html(data.veh_Cpscdz) ;     //生产地址
            ...
            parent.$('#veh_VinFourBit').html(data.veh_VinFourBit);      //vin第四位
        }else if (supplement=="1"){
            parent.$('#newDpId').val(data.id);
            parent.$('#veh_Edzk_Dp').html(data.veh_Edzk) ;
            parent.$('#veh_Zs_Dp').html(data.veh_Zs) ;
            parent.$('#veh_Zqyzzl_Dp').html(data.veh_Zqyzzl) ;
            parent.$('#veh_Bgcazzdyxzzl_Dp').html(data.veh_Bgcazzdyxzzl) ;
            parent.$('#veh_Fdjxh_Dp').html(data.veh_Fdjxh)//發動機型號
            parent.$('#veh_Clxh_Dp').html(data.veh_Clxh)     //车辆型号
            parent.$('#veh_Zj_Dp').html(data.veh_Zj)            //轴距
            parent.$('#veh_Pl_Dp').html(data.veh_Pl)           //排量和功率
            parent.$('#veh_Gl_Dp').html(data.veh_Gl)
            parent.$('#veh_Zzl_Dp').html(data.veh_Zzl)        //总质量
            parent.$('#veh_Clmc_Dp').html(data.veh_Clmc)      //车辆名称
            parent.$('#veh_Edzzl_Dp').html(data.veh_Edzzl)    //额定载质量
            parent.$('#veh_Pfbz_Dp').html(data.veh_Pfbz)   //排放标准
            parent.$('#veh_Hxnbc_Dp').html(data.veh_Hxnbc)     //货厢内部尺寸
            parent.$('#veh_Hxnbk_Dp').html(data.veh_Hxnbk)     //货厢内部尺寸
            parent.$('#veh_Hxnbg_Dp').html(data.veh_Hxnbg)      //货厢内部尺寸
            parent.$('#veh_Zxxs_Dp').html(data.veh_Zxxs)     //转向形式
            parent.$('#veh_Zbzl_Dp').html(data.veh_Zbzl)     //整备质量
            parent.$('#veh_Zh_Dp').html(data.veh_Zh)      //轴荷
            parent.$('#veh_Wkc_Dp').html(data.veh_Wkc)     //外廓尺寸
            parent.$('#veh_Wkk_Dp').html(data.veh_Wkk)     //外廓尺寸
            parent.$('#veh_Wkg_Dp').html(data.veh_Wkg)      //外廓尺寸
            parent.$('#veh_Zzllyxs_Dp').html(data.veh_Zzllyxs)      //载质量利用系数
            parent.$('#veh_Dpid_Dp').html(data.veh_Dpid)      //底盘ID
            parent.$('#veh_Dpxh_Dp').html(data.veh_Dpxh)      //底盘型号
            //parent.$('#veh_clzzqyxx').html(data.veh_clzzqyxx)      //车辆制造企业信息
            parent.$('#veh_Yh_Dp').html(data.veh_Yh)      //油耗
            parent.$('#veh_Gbthps_Dp').html(data.veh_Gbthps)     //钢板弹簧片数
            parent.$('#veh_Clpp_Dp').html(data.veh_Clpp)     //车辆品牌
            parent.$('#veh_Lts_Dp').html(data.veh_Lts)      //轮胎数
            parent.$('#veh_Clzzqymc_Dp').html(data.veh_Clzzqymc)     //车辆企业名称
            parent.$('#veh_Zgcs_Dp').html(data.veh_Zgcs)      //最高车速
            parent.$('#veh_Rlzl_Dp').html(data.veh_Rlzl)     //燃料种类
            parent.$('#veh_Qlj_Dp').html(data.veh_Qlj)     //轮距
            parent.$('#veh_Hlj_Dp').html(data.veh_Hlj)      //轮距
            parent.$('#veh_Ltgg_Dp').html(data.veh_Ltgg)     //轮胎规格
            parent.$('#veh_Jsszcrs_Dp').html(data.veh_Jsszcrs)     //驾驶室准乘人数
            parent.$('#veh_Bz_Dp').html(data.veh_Bz)      //备注
        }else{
            parent.$('#newId').val(data.id);
            parent.$('#veh_Edzk').html(data.veh_Edzk) ;
            parent.$('#veh_Zs').html(data.veh_Zs) ;
