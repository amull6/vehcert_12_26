...
<head>
    ...
    <g:set var="entityName" value="合格证更换" />
                ...
                <table id="grid" style="" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr class="om-grid-row evenRow">
                        <td align="center" abbr="id" class="col0" colspan="17"><div align="center" class="innerCol "><form id="form" method="post">
                            ...
                            <input type="hidden" value="0" id="turnOff">
    ...
    $(function() {
        $('#relate').omButton({
            ...
            onClick:function(){
                ...
                if(veh_Clsbdh!=''){
                    var url = "${createLink(controller:'ZCInfoNoAuth',action:'zcinfoRondByDpNoAuth')}?veh_Clsbdh="+veh_Clsbdh+'&turnOff='+turnOff+'&username='+username;
        ...
        $('#btn_select').omButton({
            ...
            onClick:function(){
                var veh_Need_Cer=$('#veh_Need_Cer').val();
                var turnOff=$('#turnOff').val();
                var url = '${createLink(controller:'ZCInfoNoAuth',action:'toNoticeNoAuth')}?veh_Need_Cer='+veh_Need_Cer+'&turnOff='+turnOff+'&supplement=0';
                create(url);
                $('#veh_Fdjh_Dp').val($('#veh_Fdjh').val());
                $('#veh_Csys_R_Dp').val($('#veh_Csys_R').val());
        ...
        $('#btn_select_dp').omButton({
            ...
            onClick:function(){
                var veh_Need_Cer=$('#veh_Need_Cer').val();
                var turnOff=$('#turnOff').val();
                var url = '${createLink(controller:'ZCInfoNoAuth',action:'toNoticeNoAuth')}?veh_Need_Cer=1'+'&turnOff='+turnOff+'&supplement=1';
                create(url);
        ...
        $('#newOld').click(function (){
            ...
            var turnOff=$('#turnOff').val();
            var username=$('#username').val();
            var url= '${createLink(controller:'ZCInfoNoAuth',action:'zcinfoReplaceSaveNoAuth')}?veh_Fdjh='+veh_Fdjh+"&veh_Csys_R="+veh_Csys_R+'&salesmanname='+salesmanname+'&salesmantel='+salesmantel+'&remark='+remark+"&veh_Csys_R_Dp="+veh_Csys_R_Dp+"&veh_Fdjh_Dp="+veh_Fdjh_Dp+'&username='+username;
            url=encodeURI(url);
                ...
                if(textStatus){
                    $.omMessageBox.alert({
                        ...
                        onClose:function(value){
                            var url = '${createLink(controller:'ZCInfoNoAuth',action:'zcinfoRoundNoAuth')}?turnOff='+turnOff+'&username='+username;
                            window.location.href=url;
                        }
                    });
                }
        ...
        $('#write').omButton({
            ...
            onClick:function(){
                var turnOff=$('#turnOff').val();
                var username=$('#username').val();
                var url = '${createLink(controller:'ZCInfoNoAuth',action:'zcinfoRondWriteNoAuth')}?turnOff='+turnOff+'&username='+username;
                window.location.href=url;
            }
        });
...
//                'scrolling="yes" src="'+url+'"></iframe>';
        //window.showDialog(1,content,"公告信息",1400,900);
