...
<g:if test="${nzZcinfoReAuInstance?.area_Remark}">
    <tr class="om-grid-row evenRow">
...
<g:if test="${nzZcinfoReAuInstance?.auth_Remark}">
    <tr class="om-grid-row evenRow">
        <td align="left" abbr="id" class="col0" colspan="17"><div align="left" class="innerCol ">营销公司审核备注：
        <g:textArea name="area_Remark" id="area_Remark" cols="40" rows="2" maxlength="500" style="width:600px;height:40px;" value="${nzZcinfoReAuInstance?.auth_Remark}"/>
        </div></td>
    </tr>
</g:if>
...
<script>
    $(function() {
        ...
        $("#btn_return").click(function(){
            var url = '${createLink(controller:'NZzcinfoReplaceAuth',action:'nzZcinfoReplaceForSale')}?searchType=0';
            window.location.href = url;
        });
    })
