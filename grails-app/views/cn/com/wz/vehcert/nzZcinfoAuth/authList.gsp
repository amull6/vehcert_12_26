...
<head>
    ...
    <g:set var="entityName" value="营销公司审核" />
        ...
        <form id="form_query" style="margin:8px;height:40px;">
            <table style="width:100%;border:0px;">
                <tr>
                    ...
                    <td><span>
                        <select name="auth_status" id="auth_status" style="width: 90px">
...
<script>
    ...
    $(function() {
        ...
        $('#btn_query').omButton({
            ...
            onClick:function(){
                var id=$('#user').val();
                var url = "${createLink(controller:'NZzcinfoReplaceAuth',action:'jsonListByCompany')}?area_status=1";
    ...
    function buildRightGrid(){
        $('#zcinfore_grid').omGrid({
            dataSource:'${createLink(controller:'NZzcinfoReplaceAuth',action:'jsonListByCompany')}?area_status=1&auth_status=0&searchType='+$('#searchType').val(),
            ...
            colModel:[
                ...
                {header : "审核状态", name : 'auth_status', width : 60, align : 'center',
    ...
    function gotoview(index){
        ...
        var url = '${createLink(controller:'NZzcinfoReplaceAuth',action:'auditView')}?id='+data.id+'&searchType='+$('#searchType').val();
        window.location.href = url;
