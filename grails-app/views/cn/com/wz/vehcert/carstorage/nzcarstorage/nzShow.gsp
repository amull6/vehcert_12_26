...
<html>
	<head>
		...
		<g:set var="entityName" value="${message(code: 'carstorage.label', default: 'nzCarStorage')}" />
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<g:form id="form_query">
                ...
                <c:resourceAuth resourceCode="dv_carStorage_edit">
					...
					<g:link controller="nzCarStorage" class="cancel">${message(code: 'default.button.return.label', default: 'Return')}</g:link>
				</fieldset>
			</g:form>
		</div>
    <script>
        ...
        $('#btn_edit').click(function(){
            var url = '${createLink(controller:'nzCarStorage',action:'toUpdate')}?id='+'${carStorage?.id}';
