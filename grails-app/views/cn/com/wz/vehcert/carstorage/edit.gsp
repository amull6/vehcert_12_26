...
<html>
	...
	<body>
		...
		<div id="edit-user" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${carStorage}">
			<ul class="errors" role="alert">
				<g:eachError bean="${carStorage}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${carStorage?.version}" />
			...
			$('.cancel').attr('href','javascript:void(0);');
			 $.omMessageBox.confirm({
	                ...
	                onClose:function(value){
		                if(value){
		                	window.location.href="${createLink(controller:'carStorage',action:'index')}";
			            }
	                }
	            });
		});
