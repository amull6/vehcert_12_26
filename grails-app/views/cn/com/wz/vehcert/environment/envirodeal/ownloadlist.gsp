...
<script>
    ...
    $(function() {
        ...
        $('#btn_query').omButton({
            width:80,
            onClick:function(){
                var url = "${createLink(controller:'envirPrint',action:'jsonOwnLoadList')}";
    ...
    function buildRightGrid(){
        $('#zcinfo_grid').omGrid({
            dataSource:'${createLink(controller:'envirPrint',action:'jsonOwnLoadList')}?'+encodeURI($('#form_query').serialize()),
            method:'POST',
            extraData:{list:'${list}'} ,
