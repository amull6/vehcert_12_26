...
<div style="width: 225px;height: 58px;position: absolute;right: -90px;top: 218px; text-align: center;">
    <img id="pic_fp_photo1"  src="${request.contextPath}/attachment/getImg?QRpiUrl=${BarPicUrl}" />
    <span style="font-size:14px; ">${heavyGasInfo?.en_vin}</span>
</div>
...
<table width="645px;"    border="0px" class="tabp" style="margin-left:25px;font-size: 0px;font-family:'宋体'">
    <tr>
        <td align="center" style="text-align: center">
            %{--<B>重型燃气车环保信息随车清单</B><br>--}%
            <img src="../images/en_part1_5.png" height="20px"  border="0">
        </td>
    </tr>
    <tr>
        <td colspan="12" scope="col" style="font-family:'宋体';font-size: 14px;text-align: center " >
            信息公开编号：${heavyGasInfo?.en_xxgkbh}
        </td>
    </tr>
    <tr height="1">
        <td colspan="12"></td>
...
<table width="645px;"    border="0px" class="tabp" style="margin-left:15px;font-size: 20px;font-family:'宋体'">
    ...
    <tr height="10">
        ...
        <td width="230px" style="font-family:'宋体';font-size:14px;text-align:  left">${heavyGasInfo?.en_clxh}</td>
    </tr>
    <tr height="10">
        <td width="10px" style=" font-family:'宋体';font-size:14px;">1</td>
    ...
    <tr height="10">
        ...
        <td width="300px" style="font-family:'宋体';font-size:14px;text-align:  left">${heavyGasInfo?.en_qcfl}</td>
    </tr>
    <tr height="10">
        <td width="10px" style=" font-family:'宋体';font-size:14px;">4</td>
        <td width="250px"style=" font-family:'宋体';font-size:14px;">排放阶段： </td>
        <td width="300px" style="font-family:'宋体';font-size:14px;text-align:  left">${heavyGasInfo?.en_pfjd}</td>
    </tr>
    <tr height="10">
        <td width="10px" style=" font-family:'宋体';font-size:14px;">5</td>
        <td width="250px" style="font-family:'宋体';font-size:14px;">车型的识别方法和位置：</td>
        <td width="300px" style="font-family:'宋体';font-size:14px;text-align:  left">${heavyGasInfo?.en_cldsbffhwz}</td>
    </tr>
    <tr height="10">
...
<table  width="720px;"    border="0px" class="tabp" style="margin-left:15px;font-size: 20px;font-family:'宋体'">
    ...
    <tr height="10" >
        ...
        <td style=" font-family:'宋体';font-size:14px;">${heavyGasInfo?.en_jcbz1}</td>
        <td style=" font-family:'宋体';font-size:14px;">符合</td>
    </tr>
    <tr height="10" >
        <td style=" font-family:'宋体';font-size:14px;"></td>
        <td style=" font-family:'宋体';font-size:14px;">HJ 437-2008</td>
        <td style=" font-family:'宋体';font-size:14px;">${heavyGasInfo?.en_jcbz2}</td>
        <td  style=" font-family:'宋体';font-size:14px;">符合</td>
    </tr>
    <tr height="10" >
        <td    style=" font-family:'宋体';font-size:14px;"></td>
    ...
    <tr height="10" >
        ...
        <td  style=" font-family:'宋体';font-size:14px;">${heavyGasInfo?.en_jcbz5}</td>
        <td style=" font-family:'宋体';font-size:14px;">符合</td>
    </tr>
    <tr height="10" >
        <td    style=" font-family:'宋体';font-size:14px;"></td>
        <td style=" font-family:'宋体';font-size:14px;">GB 1495-2002</td>
        <td  style=" font-family:'宋体';font-size:14px;">${heavyGasInfo?.en_jcbz6}</td>
        <td style=" font-family:'宋体';font-size:14px;">符合</td>
    </tr>
    <g:if test="${heavyGasInfo?.en_jcbz7!=''&&heavyGasInfo?.en_jcbz7!=null}">
        <tr height="10" >
            <td    style=" font-family:'宋体';font-size:14px;"></td>
            <td style=" font-family:'宋体';font-size:14px;">GB/T 27630-2011</td>
            <td  style=" font-family:'宋体';font-size:14px;">${heavyGasInfo?.en_jcbz7}</td>
            <td style=" font-family:'宋体';font-size:14px;">符合</td>
        </tr>
    </g:if>
    <tr height="10" >
...
<table width="720px;"    border="0px" class="tabp" style="margin-left:15px;font-size: 20px;font-family:'宋体'">
    ...
    <tr height="10">
        ...
        <td  colspan="2" width="300px"style=" font-family:'宋体';font-size:14px;">
            ${heavyGasInfo?.en_ycgqxh}
        </td>
    </tr>
    <tr height="10">
        <td   width="10px" style=" font-family:'宋体';font-size:14px;">21</td>
        <td  colspan="2" width="200px"style=" font-family:'宋体';font-size:14px;">蒸发器或压力调节器型号/生产厂：</td>
        <td  colspan="2" width="300px"style=" font-family:'宋体';font-size:14px;">
            ${heavyGasInfo?.en_zfqhyltjqxh}
        </td>
    </tr>
    <tr height="10">
        <td   width="10px" style=" font-family:'宋体';font-size:14px;">22</td>
        <td  colspan="2" width="200px"style=" font-family:'宋体';font-size:14px;">混合装置型号/生产厂</td>
        <td  colspan="2" width="300px"style=" font-family:'宋体';font-size:14px;">
            ${heavyGasInfo?.en_hhzzxh}
        </td>
    </tr>
    <tr height="10">
        <td   width="10px" style=" font-family:'宋体';font-size:14px;">23</td>
        <td  colspan="2" width="200px"style=" font-family:'宋体';font-size:14px;">喷射器型号/生产厂：</td>
        <td  colspan="2" width="300px"style=" font-family:'宋体';font-size:14px;">
            ${heavyGasInfo?.en_psqxh}
        </td>
    </tr>
    ...
    <tr height="10">
        ...
        <td  colspan="2" width="300px"style=" font-family:'宋体';font-size:14px;">
            ${heavyGasInfo?.en_ecuxh}
        </td>
    </tr>
    <tr height="10"   style="vertical-align:top">
        <td   width="10px"  rowspan="1" style=" font-family:'宋体';font-size:14px;">28</td>
        <td  colspan="2" width="200px"style=" font-family:'宋体';font-size:14px;">OBD型号/生产厂：</td>
        <td  colspan="2" width="300px"style=" font-family:'宋体';font-size:14px;">
            ${heavyGasInfo?.en_obdxh}
        </td>
    </tr>
    <tr height="10"   style="vertical-align:top">
        <td   width="10px"  rowspan="1" style=" font-family:'宋体';font-size:14px;">29</td>
        <td  colspan="2" width="200px"style=" font-family:'宋体';font-size:14px;">曲轴箱污染物排放控制装置型号/生产厂：</td>
        <td  colspan="2" width="300px"style=" font-family:'宋体';font-size:14px;">
            ${heavyGasInfo?.en_qzxwrwpfkzzzxh}
        </td>
    </tr>
    <tr height="10">
