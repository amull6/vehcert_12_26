		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<g:form id="form_query">
				...
				<fieldset class="buttons" style="margin:20px 8px 0px 4px;padding-left:280px;">
					...
					<g:link controller="lightDual" class="cancel">${message(code: 'default.button.return.label', default: 'Return')}</g:link>
				</fieldset>
			</g:form>
		</div>
    <script>
        ...
        $('#btn_edit').click(function(){
            var url = '${createLink(controller:'lightDual',action:'edit')}?id='+'${lightDualInstance?.id}';
