...
<div id="page" style="background-color:white;">
    <div id="center-panel" style="margin-left:4px;border:1px;">
        <form id="form_query" style="margin:8px;">
            <table style="width:100%;border:0px;">
                <tr>
                    ...
                    <td width="100"><span><g:textField id="dealerNum" name="dealerNum" maxlength="200" style="width: 115px;"/></span></td>
                    <td width='10'></td>
                    <td width="80"><span><g:message code="paper.dealerName.label" default="dealerName" />：</span></td>
                    <td width="100"><span><g:textField id="dealerName" name="dealerName" maxlength="200" style="width: 115px;"/></span></td>
                    <td width='10'></td>
                    <td width="80"><span><g:message code="paperDealer.paperNum.label" default="paperNum" />：</span></td>
                    <td width="100"><span><g:textField id="paperNum" name="paperNum" maxlength="200" style="width: 115px;"/></span></td>
                    <td width='10'></td>
        ...
        <fieldset class="buttons" style="margin:0px 8px 8px 4px;">
            <export:formats formats="['excel']"  controller="paperDealer" action="export" style="border:0px;margin-top:-2px;"/>
        </fieldset>
...
<script>
    ...
    $(function() {
        ...
        $(".excel").click(function(){
           ...
           var dealerNum= $("#dealerNum").val();
            ...
            var url="${createLink(controller:'paperDealer',action:'export')}?format=excel&extension=xlsx&paperNum="+paperNum+"&type="+type+"&dealerNum="+dealerNum+"&dealerName="+dealerName;
            //url=encodeURI(url);
    ...
    function buildRightGrid(){
        $('#PaperDealer_grid').omGrid({
            dataSource:'${createLink(controller:'paperDealer',action:'jsonListAll')}',
            title:"<g:message code="default.list.label" args="[entityName]"/>",
            singleSelect:false,
            limit : 12,
            height :440,
