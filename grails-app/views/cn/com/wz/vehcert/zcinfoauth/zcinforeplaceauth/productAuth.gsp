...
<tr class="om-grid-row evenRow">
    ...
    <g:textArea name="product_auth_Remark" id="product_auth_Remark" cols="40" rows="1"  style="width:600px;height:40px;" value="${zcinfoReAuInstance?.product_auth_Remark}"/>
        </div></td>
...
<tr class="om-grid-row evenRow">
    <td align="center" abbr="id" class="col0" colspan="17"><div align="center" class="innerCol ">
        <g:if test="${zcinfoReAuInstance?.product_auth_status==0}">
        ...
        <g:link controller="ZCInfoReplaceAuth" style="line-height:20px;font-size: 14px;" class="btn_basic blue_black" action="productAuthList"  >${message(code: 'default.button.return.label', default: 'Return')}</g:link>
...
<script language="javascript" type="text/javascript">
    ...
    $("#btn_noPass").click(function(){
        var url = '${createLink(controller:'ZCInfoReplaceAuth',action:'productAudit')}?id='+$("#zcinforeid").val()+"&product_auth_Remark="+encodeURI($("#product_auth_Remark").val())+'&pass=N';
        window.location.href = url;
    });
    $("#btn_pass").click(function(){
        var url = '${createLink(controller:'ZCInfoReplaceAuth',action:'productAudit')}?id='+$("#zcinforeid").val()+"&product_auth_Remark="+encodeURI($("#product_auth_Remark").val())+'&pass=Y';
        window.location.href = url;
    });
</script>
</body>
