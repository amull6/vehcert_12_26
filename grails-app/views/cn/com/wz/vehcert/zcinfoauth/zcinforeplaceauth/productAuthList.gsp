		...
		<div id="page" style="width:98%;background-color:white;">
			...
			<table style="width:100%;border:0px;">
				  <tr>
				    ...
				    <td width="100px" align='left'><span><g:textField id="veh_Clsbdh" name="veh_Clsbdh" maxlength="200"/></span></td>
                      <td width="80px" align="right"><span><g:message code="zcinfore.veh_Fdjh.label" default="旧发动机号" />：</span></td>
                      <td width="100px" align="left"><span><g:textField id="veh_Fdjh" name="veh_Fdjh" maxlength="200" style="width: 80px"/></span></td>
                      ...
                      <td><span>
                          <select name="product_auth_status" id="product_auth_status" style="width: 90px">
	 	...
	 	<script>
			...
			$(function() {
	                  ...
	                  //绑定查询按钮事件
	                   $('#btn_query').omButton({
		                	   ...
		                	   onClick:function(){
                                   var id=$('#user').val();
				   	                    var url = "${createLink(controller:'ZCInfoReplaceAuth',action:'jsonListByProduct')}";
				   	                    url+='?searchType=2&'+$('#form_query').serialize();
			...
			function buildRightGrid(){
				$('#zcinfore_grid').omGrid({
					dataSource:'${createLink(controller:'ZCInfoReplaceAuth',action:'jsonListByProduct')}?product_auth_status=0&searchType=2',
					...
					colModel:[
                        {header : "${message(code: 'zcinfo.opertion.label', default: '操作')}", name : 'id', width: 80, align:'center', renderer:
                              ...
                              {header : "审核状态", name : 'product_auth_status', width : 60, align : 'center',
            ...
            function gotoview(index){
                ...
                var url = '${createLink(controller:'ZCInfoReplaceAuth',action:'productAuthView')}?id='+data.id;
                 window.location.href = url;
