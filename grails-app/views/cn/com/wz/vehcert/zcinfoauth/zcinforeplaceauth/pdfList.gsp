	 	...
	 	<script>
			...
			$(function() {
                ...
                $('#btn_query').omButton({
                    ...
                    onClick: function () {
                        ...
                        url += '?veh_coc_status=0&formal=1&' + $('#form_query').serialize() + '&user.id=' + id + '&searchType=1';
			...
			function buildRightGrid(){
				$('#zcinfore_grid').omGrid({
					dataSource:'${createLink(controller:'ZCInfoReplaceAuth',action:'jsonListByDealer')}?veh_coc_status=0&formal=1&'+$('#form_query').serialize(),
