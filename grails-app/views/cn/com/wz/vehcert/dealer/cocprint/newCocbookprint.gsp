...
<form id="form1" style="position: relative">
    <img id="pic_fp_photo"  src="${request.contextPath}/attachment/getImg?QRpiUrl=${QRpiUrl}" style="width: 100px;height: 100px;position: absolute;right: 60px;top: -82px"/>
    %{--<img id="pic_fp_photo"  src="${request.contextPath}/attachment/getImg?QRpiUrl=${QRpiUrl}" style="width: 100px;height: 100px;position: absolute;right: 60px;top: -70px"/>--}%
    <table width="600px;"   border="0px" class="tabp" style="margin-left:15px;margin-top: 120px;font-size: 16px;font-family:'宋体'">
        <tr>
            <td colspan="4" scope="col"style='font-weight:bolder;text-align: center'><B>（用于完整车辆）</B>
            </td>
        </tr>
        <tr>
            <td colspan="4" scope="col" style='font-weight: bold ;text-align: center ' >第一部分 车辆总体信息
            %{--</br><hr style="boder:none;border-top:1px solid #000000;" />--}%
            </td>
        </tr>
        <tr height="20">
            <td></td>
        ...
        <tr>
            <td colspan="4" scope="col"style='font-weight: bold'>车辆一致性证书编号：${cocPrnInstance?.coc_yzxzsbh}
            </td>
        </tr>

        <tr height="10">
            <td width="50px" >0.1</td>
            <td width="250px">车辆生产厂名称 </td>
            <td width="10px">:</td>
            <td width="280px">${cocPrnInstance?.coc_clsccmc}</td>
        </tr>
        <tr height="20">
        ...
        <tr height="20">
            <td height="20" colspan="3">CCC认证过程中车辆的制造阶段</td>
            <td colspan="3"></td>
        </tr>
        <tr height="20">
            <td height="20"></td>
            <td colspan="4">最终阶段</td>
        </tr>
        <tr height="20">
            <td height="20"></td>
        ...
        %{--</tr>--}%
        <tr height="20">
            <td colspan="4"  style="text-align: right">&nbsp;&nbsp;&nbsp;制造日期:${cocPrnInstance?.coc_rq}</td>
        </tr>
    </table>
</form>
...
<tr  height="15px">
    ...
    <td >12.1行驶状态下带车身的车辆质量(kg)</td>
    <td >${cocPrnInstance?.coc_xsxdcsclzl}</td>
</tr>
<tr  height="15px">
    <td >14.1额定总质量(kg)</td>
