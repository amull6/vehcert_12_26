                    ...
                    <table id="grid" style="" cellpadding="0" cellspacing="0" border="0">
                        ...
                        <tr>
                            <td align="center" colspan="8"><div align="center" class="innerCol ">
                                <g:if test="${suctype == '0'}">
                                    <g:link controller="ZCInfoUpload" action="uploadSoleInfo" id="${zcinfoInstance?.id}" class="btn_basic blue_black" ><g:message code="default.button.upload.label" default="Upload" /></g:link>&nbsp;&nbsp;
                                    <g:link controller="ZCInfoUpload" action="list" class="btn_basic blue_black" >${message(code: 'default.button.return.label', default: 'Return')}</g:link>
                                </g:if>
                                <g:if test="${suctype == '1'}">
                                    <g:link controller="ZCInfoUpload" action="uploadSucList" class="btn_basic blue_black" >${message(code: 'default.button.return.label', default: 'Return')}</g:link>
                                </g:if>
                                <g:if test="${suctype=='2'}">
                                    <g:link controller="ZCInfoUpload" action="toUploadByHand" class="btn_basic blue_black" >${message(code: 'default.button.return.label', default: 'Return')}</g:link>
                                </g:if>
                            </div></td>
                        </tr>
