...
/**
 *@Description  一致性证书基础信息
 *@Auther mike
 *@createTime 2013-07-24
 *@updateTime 2017-09-24
 */
class CocCarStorage {
    String id;
    /**
    ...
    static constraints = {
        ...
        coc_updater(nullable:true)
        coc_yzxzsbh(nullable:true)
    ...
    static mapping={
        ...
        coc_updateTime (comment:'更新时间')
        coc_updater (comment:'更新人')

        coc_yzxzsbh (comment:'一致性证书编号')

        coc_new_energy (comment:'是否新能源')
