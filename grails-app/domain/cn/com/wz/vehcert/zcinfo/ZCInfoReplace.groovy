...
class ZCInfoReplace {
    ...
    int transToSap = 0 //0表示要传给SAP，1传输失败，2传输成功,3禁止传输到SAP
    String  sapTime         //传到SAP时间
    static constraints = {
        veh_Need_Cer()
        ...
        transToSap(blank: true, nullable: true)
        sapTime(blank: true, nullable: true)
    }

    static mapping = {
        table 'WZH_ZCINFO_REPLACE'
        ...
        transToSap(comment: '0表示要传给SAP，1传输失败，2传输成功')
        sapTime(comment: '更换后合格证传到SAP的时间')
