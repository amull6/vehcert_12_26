...
/**
 * @Description 公告信息/一致性信息 临时表 desc：用来存储修改 删除后ID信息  车间同步数据问题
...
class Temp {
    ...
    static mapping = {
        ...
        wzh_carstorageID (comment:'公告信息/一致性信息ID')
        wzh_type (comment:'类型 1 公告信息  2 一致性信息')
