...
public final class HttpServletRequestWrapperFilter implements Filter {
    ...
    protected Principal retrievePrincipalFromSessionOrRequest(final ServletRequest servletRequest) {
        ...
        final Assertion assertion = (Assertion) (session == null ? request.getAttribute(parent.cas.util.AbstractCasFilter.CONST_CAS_ASSERTION) : session.getAttribute(parent.cas.util.AbstractCasFilter.CONST_CAS_ASSERTION));
