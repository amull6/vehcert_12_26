...
public final class AssertionThreadLocalFilter implements Filter {
    ...
    public void doFilter(final ServletRequest servletRequest, final ServletResponse servletResponse, final FilterChain filterChain) throws IOException, ServletException {
        ...
        final Assertion assertion = (Assertion) (session != null ? session.getAttribute(parent.cas.util.AbstractCasFilter.CONST_CAS_ASSERTION) : null);

        try {
            parent.cas.util.AssertionHolder.setAssertion(assertion);
