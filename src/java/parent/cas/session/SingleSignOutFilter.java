 ...
 */
package parent.cas.session;

import parent.cas.util.AbstractConfigurationFilter;
...
public final class SingleSignOutFilter extends AbstractConfigurationFilter {
    ...
    private static parent.cas.session.SessionMappingStorage SESSION_MAPPING_STORAGE = new parent.cas.session.HashMapBackedSessionMappingStorage();
    ...
    public void setSessionMappingStorage(final parent.cas.session.SessionMappingStorage storage) {
