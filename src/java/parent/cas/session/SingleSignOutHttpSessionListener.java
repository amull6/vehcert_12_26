...
public final class SingleSignOutHttpSessionListener implements HttpSessionListener {
	...
	private parent.cas.session.SessionMappingStorage SESSION_MAPPING_STORAGE;
    ...
    /**
     * Obtains a {@link parent.cas.session.SessionMappingStorage} object. Assumes this method will always return the same
     * instance of the object.  It assumes this because it generally lazily calls the method.
     * 
     * @return the SessionMappingStorage
     */
    protected static parent.cas.session.SessionMappingStorage getSessionMappingStorage() {
