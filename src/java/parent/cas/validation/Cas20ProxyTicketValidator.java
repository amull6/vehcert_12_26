 ...
 * http://www.ja-sig.org/products/parent.cas/overview/license/index.html
 */
...
public final class Cas20ProxyTicketValidator extends Cas20ServiceTicketValidator {
    ...
    protected void customParseResponse(final String response, final parent.cas.validation.Assertion assertion) throws TicketValidationException {
