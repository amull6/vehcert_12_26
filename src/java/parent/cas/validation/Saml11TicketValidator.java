 ...
 * @since 3.1
 */
public final class Saml11TicketValidator extends parent.cas.validation.AbstractUrlBasedTicketValidator {
    ...
    protected parent.cas.validation.Assertion parseResponseFromServer(final String response) throws TicketValidationException {
        try {
