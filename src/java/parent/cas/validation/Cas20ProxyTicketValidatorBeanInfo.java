...
public final class Cas20ProxyTicketValidatorBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            final PropertyDescriptor descriptor = new PropertyDescriptor("allowedProxyChains", parent.cas.validation.Cas20ProxyTicketValidator.class, null, "setAllowedProxyChains") {
                public PropertyEditor createPropertyEditor(final Object bean) {
                    return new ProxyListPropertyEditor();
                }
            };
            
            final PropertyDescriptor acceptAnyProxy = new PropertyDescriptor("acceptAnyProxy", parent.cas.validation.Cas20ProxyTicketValidator.class, null, "setAcceptAnyProxy") {
                public PropertyEditor createPropertyEditor(final Object bean) {
